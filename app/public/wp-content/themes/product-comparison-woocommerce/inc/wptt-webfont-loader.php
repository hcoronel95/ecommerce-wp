...
if ( ! function_exists( 'product_comparison_woocommerce_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function product_comparison_woocommerce_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
...
if ( ! function_exists( 'product_comparison_woocommerce_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function product_comparison_woocommerce_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Product_Comparison_Woocommerce_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
