...
<div class="container">
  <main id="content" role="main" class="middle-align web-frame">
    <?php
        ...
        <div class="row">
          ...
          <div id="our-services" class="services col-lg-8 col-md-8">
            <?php if( get_theme_mod( 'product_comparison_woocommerce_blog_post_pagination_position','bottom') == 'top' || get_theme_mod( 'product_comparison_woocommerce_blog_post_pagination_position','bottom') == 'both') { ?>
            ...
            ?>
            <?php if( get_theme_mod( 'product_comparison_woocommerce_blog_post_pagination_position','bottom') == 'bottom' || get_theme_mod( 'product_comparison_woocommerce_blog_post_pagination_position','bottom') == 'both') { ?>
              <?php if( get_theme_mod( 'product_comparison_woocommerce_blog_pagination_hide_show',true) == 1) { ?>
                <div class="navigation">
                  <?php product_comparison_woocommerce_blog_posts_pagination(); ?>
                  <div class="clearfix"></div>
    ...
    <?php }else if($product_comparison_woocommerce_theme_lay == 'Three Columns'){ ?>
      <div class="row">
    ...
    <?php }else if($product_comparison_woocommerce_theme_lay == 'Four Columns'){ ?> 
      <div class="row">
        <div class="col-lg-3 col-md-3" id="sidebar"><?php dynamic_sidebar('sidebar-1');?></div>
