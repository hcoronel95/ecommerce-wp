...
export const TIME_TO_WAIT_TO_CHECK_PURCHASED_LABEL_STATUS_MS = 3000;

// Maximum number of retries for checking label status (60 retries * 3 seconds = 3 minutes)
export const MAX_LABEL_STATUS_RETRIES = 60;
